...
adata_orig.obs['treated_label'] = np.where((adata_orig.obs['dose'] == '10.0') | (adata_orig.obs['dose'] == '0.0'), adata_orig.obs['treated_label'],'Other' )
adata_orig.var['ensembl_id']  = [s.split('.')[0] for s in adata_orig.var['ensembl_id']]

adata_orig.write_h5ad('C:/Users/nbrouwer1/Documents/VS_projects/prepare_data/input_files/sciplex_processed/sciplex2_processed3.h5ad')
